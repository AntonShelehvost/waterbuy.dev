        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <form class="form-horizontal" action="/admin/export_from_xls" id="export" method="post"
                        ...
                        <div class="form-group">
                            ...
                            table-hover" id="Address2" width="100%" style="width: 100%;">
                                    <br>
                                    <thead>
                                    <tr>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-md-3">Для загрузки списка товаров из xls|xlsx
                            ...
                            <div class="col-md-6">
                                <label class="btn btn-success" for="my-file-selector">
                                    ...
                                    <input id="my-file-selector" type="file" class="margin-bottom-10"
                                           name="prd_file_certificates"
                                           style="display:none;"
                    ...
                    <form action="/admin/add_products" class="form-horizontal" method="post" accept-charset="utf-8"
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-md-3"
                                   for="prd_title_producer">Производитель:</label>
                            <div class="col-xs-12 col-md-9">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-md-3" for="prd_file">Загрузить фото из
                                файла:</label>
                            <div class="col-xs-12 col-md-9">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-md-3" for="exampleInputFile1">Загрузить
                                сертификаты
                                качества:
                            </label>
                            <div class="col-xs-12 col-md-9">
    ...
    $(document).ready(function () {
        ...
        table2 = $('#Address2').DataTable({
            ...
            "language": {
                ...
                // Load data for the table's content from an Ajax source
                "ajax": {
                    "url": "<?php echo site_url('admin/ajax_address_region_selector')?>?provider=" + $('#prd_id_user2').val(),
                    "type": "POST"
                },
        ...
        $('#prd_id_user2').on('change', function () {
            $('#provider2').val($('#prd_id_user').val());
            table2.ajax.url('/admin/ajax_address_region_selector?provider=' + $('#prd_id_user2').val());
            table2.ajax.reload();
        });
