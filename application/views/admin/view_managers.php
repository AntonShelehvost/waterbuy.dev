 ...
 */
//echo "<pre>";
//var_dump($client->use_male,($client->use_male == "1") ? 'checked' : "");
//echo "</pre>";
?>
<div class="row">
	<div class="box col-md-12">
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				<h2><i class="glyphicon glyphicon-phone"></i> Карточка менеджера</h2>
			...
			<div class="box-content">
				...
				<form class="form-horizontal" method="post" action="">
					...
					<div class="form-group">
						...
						<div class="col-xs-9">
								<span class="control-label">г.<?php echo $client->cit_name; ?>
									ул.<?php echo $client->use_street; ?> дом.<?php echo $client->use_building; ?>
									кв/пом.<?php echo $client->use_room; ?>
									домофон (<?php echo $client->use_intercom; ?>)
								</span>
					...
					<div class="form-group">
						...
						<div class="col-xs-2">
							<label class="radio-inline">
								<input type="radio" name="use_male" <?= ($client->use_male == "1") ? 'checked' : ""; ?>>
								Мужской
							</label>
						</div>
						<div class="col-xs-2">
							<label class="radio-inline">
								<input type="radio" name="use_male" <?= ($client->use_male == "2") ? 'checked' : ""; ?>>
								Женский
							</label>
						</div>
					</div>
