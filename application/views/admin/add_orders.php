        ...
        <form class="form-horizontal">
            <div class="form-group">
                <div class="col-xs-12 col-md-3">
                    ...
                    <div class="controls">
                        <select data-placeholder="Введите название страны" class="col-xs-12 col-md-12" id="selectError2"
                                data-rel="chosen">
                            <option value=""></option>
                        </select>
                    </div>
                ...
                <div class="col-xs-12 col-md-3">
                    ...
                    <div class="controls">
                        <select data-placeholder="Введите название области" class="col-xs-12 col-md-12"
                ...
                <div class="col-xs-12 col-md-3">
                    ...
                    <div class="controls">
                        <select data-placeholder="Введите название города" class="col-xs-12 col-md-12" id="selectError2"
                                data-rel="chosen">
                            <option value=""></option>
                        </select>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-md-3">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select data-placeholder="Введите название района" class="col-xs-12 col-md-12"
                                    id="selectError2" data-rel="chosen">
                                <option value=""></option>
				...
				<form class="form-horizontal">
					...
					<div class="form-group">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <label for="fatherName">Отчество:</label>
                            <input type="text" class="form-control" id="fatherName" placeholder="Введите фамилию">
                            <p class="help-block">Введите отчество клиента, если он еще не зарегистрирован на сайте.</p>
                        </div>
                                    ...
                                    <div id="panel1" class="tab-pane fade in active">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-md-12">
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title">Вода негазована/ТМ Аляска </h3>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    <div class="img-responsive col-xs-12 col-md-2">
                                        <img src="/assets/img/myrgorod.png" alt="" class="img-responsive center-block">
                                    </div>
                                    <div class="col-xs-12 col-md-10">
                                        <div class="col-xs-12 col-md-6">
                                            <h5>Цена <span class="badge">25 грн</span></h5>
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            ...
                                            <div class="input-group  col-md-12">
                                                ...
                                                <input id="calc" type="text" class="form-control text-center" value="1">
                                                <span class="input-group-btn">
                                        ...
                                        <div class=" col-xs-12 col-md-10">
                                            Аляска — кристально чистая вода, в которой благодаря бережному очищению
                                            сохраняется идеальный баланс полезных минералов.
                                        </div>
                                    </div>
                                </div>
                            </div>
