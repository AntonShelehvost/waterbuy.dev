 ...
 * Time: 00:17
 */
class Model_managers extends CI_Model
{
	...
	private function _get_datatables_query()
	{
		...
		$this->db->join('employees_groups', 'employee.emp_employees_groups_id = employees_groups.emg_id and employees_groups.emg_id=4');
		$i = 0;
